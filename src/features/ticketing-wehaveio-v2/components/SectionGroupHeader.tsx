...
export function SectionGroupHeader({
  ...
  return (
    <button
      ...
      className="flex w-full items-center justify-between gap-4 bg-[var(--wehave-v2-surface)] px-4 py-3 text-left transition hover:bg-[var(--wehave-v2-surface-soft)] sm:px-5"
    >
